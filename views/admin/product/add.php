...
<form action="?url=luu-them-san-pham" method="POST" enctype="multipart/form-data">
    <div class="">
    <div class="box">
        <label for="">Tên</label>
    ...
    <div class="box">
        ...
        <input type="text" name="sp_sale">
    </div>
    <div class="box">
        <label for="">Số lượng</label>
        <input type="text" name="sp_quantity">
    </div>
    </div>
    <div class="">
    <div class="box">
    ...
    <div class="box">
        <label for="">Mô tả ngắn</label>
           <textarea name="sp_intro"   id="summernote2" id="" cols="30" rows="10"></textarea>
    </div>
    <div class="box">
        <label for="">Mô tả dài</label>
            <textarea name="sp_description"  id="summernote" id="" cols="30" rows="10"></textarea>
    </div>
    </div>
